...
import { PanelLeft, BarChart, Wine, HandCoins, UserCog, BotMessageSquare, CookingPot, FileText, Utensils, Building, Users, LogOut, Home, History, Beaker, Archive, BookOpenCheck, DollarSign } from "lucide-react"
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group hidden md:flex flex-col h-svh text-sidebar-foreground bg-sidebar transition-[width] ease-linear duration-200",
            ...
            <Sidebar>
                <SidebarHeader>
                  <Link href="/" className="flex items-center gap-2 font-bold text-lg">
                    <LogoIcon />
                    <span className="group-data-[state=collapsed]:hidden">SommelierPro AI</span>
                  </Link>
                </SidebarHeader>
                <SidebarContent>
                    <SidebarGroup>
                    ...
                    {authLoading ? (
                        ...
                        <>
                            ...
                            {(profile?.role === 'admin' || profile?.role === 'vendedor') && (
                                <SidebarGroup>
                                    <SidebarGroupLabel>Afiliados</SidebarGroupLabel>
